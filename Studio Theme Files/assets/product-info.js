  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      connectedCallback() {
        ...
        this.querySelector('media-gallery')?.applyVariantMediaFilter?.(this.getSelectedVariant(this));
      ...
      updateMedia(html, variant) {
        ...
        this.querySelector('media-gallery')?.applyVariantMediaFilter?.(variant);
